...
export default function Testimonials() {
  ...
  >
            ...
            <div className="flex gap-1.5">
              {testimonialsData.map((_, i) => <button
    key={i}
    onClick={() => setActiveIndex(i)}
    className={`w-2 h-2 rounded-full cursor-pointer transition-all ${activeIndex === i ? "bg-indigo-600 w-4" : "bg-slate-300 dark:bg-slate-800"}`}
