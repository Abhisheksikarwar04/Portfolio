...
import { Mail, Phone, MapPin, Send, Copy, Check, Share2, Sparkles, Loader2, Linkedin, Github } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5" id="contact-gate-form">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-xl border bg-white/10 dark:bg-white/5 text-slate-800 dark:text-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all glass ${
                      errors.name ? "border-rose-500" : "border-slate-200/30 dark:border-white/10"
                    }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-xl border bg-white/10 dark:bg-white/5 text-slate-800 dark:text-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all glass ${
                      errors.email ? "border-rose-500" : "border-slate-200/30 dark:border-white/10"
                    }`}
                  />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 rounded-xl border bg-white/10 dark:bg-white/5 text-slate-800 dark:text-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all glass ${
                    errors.subject ? "border-rose-500" : "border-slate-200/30 dark:border-white/10"
                  }`}
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-2.5 rounded-xl border bg-white/10 dark:bg-white/5 text-slate-800 dark:text-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all resize-none glass ${
                    errors.message ? "border-rose-500" : "border-slate-200/30 dark:border-white/10"
                  }`}
                />
