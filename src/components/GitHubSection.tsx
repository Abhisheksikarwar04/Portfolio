...
export default function GitHubSection() {
  ...
  const fetchGithubData = async () => {
    ...
    try {
      ...
      // Soft fallbacks so the page NEVER looks broken
      setStats({
        reposCount: 5,
        followers: 12,
        following: 5,
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {error && (
          <div className="max-w-2xl mx-auto mb-6 text-center text-xs text-rose-500 bg-rose-500/5 py-2 px-4 rounded-xl border border-rose-500/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            ...
            <div className="p-6 rounded-3xl glass hover:scale-[1.01] hover:shadow-lg transition-all duration-300 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                {(() => {
                  const totalReposCount = Object.values(stats.languages).reduce((a: any, b: any) => Number(a) + Number(b), 0) as number;
                  return Object.entries(stats.languages).slice(0, 4).map(([lang, count]) => (
                    <div key={lang}>
                      ...
                      <div className="w-full h-1.5 bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                          width: `${totalReposCount > 0 ? ((count as number) / totalReposCount) * 100 : 0}%`
                          }}
                        />
                      </div>
                    </div>
          ...
          <div className="lg:col-span-8 flex flex-col gap-4">
            ...
            {loading ? (
              <div className="flex items-center justify-center py-20 rounded-3xl glass">
