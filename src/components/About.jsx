...
export default function About() {
  ...
  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {personalInfo.specializations.map((spec, i) => <div key={i} className="flex items-center gap-2.5">
  ...
  >
              ...
              <div className="flex flex-wrap gap-2">
                {personalInfo.softSkills.map((skill, index) => <span
    key={index}
