...
export default function Footer() {
  ...
  return <footer className="relative bg-transparent transition-colors border-t border-slate-200/20 dark:border-white/10 py-12">
    ...
    /* Left Side: Copyright and Author */
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-200">
            © {(/* @__PURE__ */ new Date()).getFullYear()} {personalInfo.name}. All rights reserved.
          </p>
