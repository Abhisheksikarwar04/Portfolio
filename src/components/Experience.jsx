...
export default function Experience() {
  ...
  />
    ...
    return <div
      key={exp.id}
      className={`relative flex flex-col md:flex-row items-stretch w-full ${isEven ? "md:flex-row-reverse" : ""}`}
    ...
    >
      ...
      /* Responsibilities list */
                      ...
                      <div>
                        ...
                        <ul className="flex flex-col gap-2">
                          {exp.responsibilities.map((resp, i) => <li key={i} className="flex items-start gap-2.5 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
      ...
      /* Achievements section */
                      ...
                      {exp.achievements.length > 0 && <div className="p-3 bg-indigo-500/5 rounded-xl border border-indigo-500/10">
                          ...
                          <ul className="flex flex-col gap-1">
                            {exp.achievements.map((ach, i) => <li key={i} className="text-xs text-slate-600 dark:text-slate-300">
                                • {ach}
                              </li>)}
                          </ul>
                        </div>}
      ...
      /* Tech Stack used pills */
                      ...
                      <div className="flex flex-wrap gap-1.5 pt-2">
                        {exp.technologies.map((tech) => <span
      key={tech}
