...
import { X, Github, ExternalLink, Cpu, Hammer, Share2 } from "lucide-react";
export default function ProjectModal({ project, onClose, onShare }) {
  ...
  return <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-slate-900/60 backdrop-blur-md">
      {
    ...
    /* Key Features list */
              ...
              <div>
                ...
                <ul className="flex flex-col gap-2">
                  {project.keyFeatures.map((feat, i) => <li key={i} className="flex items-start gap-2 text-sm text-slate-600 dark:text-slate-300">
    ...
    /* Tech Stack Pills */
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {project.techStack.map((tech) => <span
    key={tech}
